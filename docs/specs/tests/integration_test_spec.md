...
| 項目 | 型 | 説明 | 例 |
|------|-----|------|-----|
| mock_members | List[Dict] | 擬似メンバー情報 | [{"id": "123456789", "name": "田中太郎", "display_name": "田中"}, {"id": "987654321", "name": "佐藤花子", "display_name": "佐藤"}, {"id": "456789123", "name": "鈴木一郎", "display_name": "鈴木"}] |
| channel_id | str | 対象のボイスチャンネルID | "762140202625925151" |
